...
- Python, pyproject: `jarvis-runtime` v4.2.0a0, entry `jarvisd` (`jarvis.cli:main`); produkcyjny daemon launchd: `com.ozzy.jarvisd` → `~/.jarvis/bin/jarvisd`.
