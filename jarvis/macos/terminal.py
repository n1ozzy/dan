...
# Fixed script sources (ADR-021): the only AppleScript jarvisd will ever
...
_DEFAULT_FIXTURE_LINES = [
    "JARVIS FAKE TERMINAL — D5 smoke fixture",
...
def _probe() -> int:
    """Manual TCC/onboarding probe: ``python -m jarvis.macos.terminal [app]``.
    ...
    try:
        ...
        report["hint"] = (
            "Grant Automation (Apple Events) from the process hosting jarvisd "
...
if __name__ == "__main__":
    ...
    # as jarvis.macos.terminal — two distinct TerminalError classes otherwise
    # (the D2 probe lesson). Delegate to the canonical module instance.
    from jarvis.macos import terminal as _canonical
