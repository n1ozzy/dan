"""SQLite-backed DAN-owned memory blocks."""
...
from dan.memory.policies import select_memory_for_budget, validate_memory_kind
...
class MemoryError(Exception):
    """Raised when DAN-owned memory cannot be read or written."""
