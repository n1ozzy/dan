...
DAN is a single active brain for now. Workers can come back later as isolated
technical task runs, but they must not create extra DAN chats/sessions or
...
def _disabled() -> dict[str, Any]:
    return {
        "ok": False,
        "status": 410,
        "error": "workers are disabled on this runtime branch; use the main DAN brain directly",
        "jobs": [],
    }
