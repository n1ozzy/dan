...
from dan.voice.vad import CaptureGate
...
class TranscriptionPipeline:
    def __init__(
        ...
        *,
        ...
        self._executor = ThreadPoolExecutor(max_workers=1, thread_name_prefix="dan-stt")
    ...
    def _append_event(self, text: str, decision: Any) -> bool:
        ...
        try:
            ...
            # dand owns truth: an unpersisted transcript must not act.
