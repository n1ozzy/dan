...
dand (CONTRACTS.md §13, ADR-009, ADR-015: history lives in ``events`` as
...
from dan.workers.jobs import WorkerJob, WorkerJobStatus, WorkerResult
...
class WorkerBroker:
    ...
    def execute(self, job_id: str) -> WorkerJob:
        ...
        # The worker only PROPOSED memory; dand writes it, and only as an
