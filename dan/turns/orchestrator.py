...
from dan.brain.base import BrainGenerationCancelled, BrainResponse
...
from dan.store.repositories import RepositoryError, ensure_mapping, ensure_non_empty_text
...
def _direct_tool_continuation_input_text(
    *,
    ...
    header = "\n".join(
        (
            "Continuation after direct DAN tool execution in the same turn.",
            ...
            "If another DAN tool is genuinely needed, request it through the "
