"""Logging setup and redaction helpers for DAN."""
...
class SecureRotatingFileHandler(RotatingFileHandler):
    ...
    FIX-10 secured `dand.log` to 0600, but a plain rotation reopens the base
...
def configure_logging(config: DANConfig, paths: RuntimePaths | None = None) -> stdlib_logging.Logger:
    """Configure DAN console and file logging without starting runtime services."""
