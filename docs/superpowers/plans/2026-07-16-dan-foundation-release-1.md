...
| klasyfikacja pełnych 2278 testów | Task 2 |
...
python scripts/dan-test-baseline --expect-collected 2278
```
...
If collection differs from `2278`, stop and reconcile the spec with actual
